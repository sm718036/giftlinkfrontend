...
const NotFoundPage = () => {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#f6f0df] px-4">
      <div className="max-w-2xl w-full text-center">
        {/* 404 Number */}
        <div className="mb-8">
          <h1 className="display-serif text-9xl text-[#08704c] tracking-tight">404</h1>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <NotFoundPageButton onClick={navigateToHome} variant="dark" label="Go Home" />
